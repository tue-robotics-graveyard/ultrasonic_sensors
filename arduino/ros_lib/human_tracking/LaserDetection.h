#ifndef _ROS_human_tracking_LaserDetection_h
#define _ROS_human_tracking_LaserDetection_h
...
namespace human_tracking
{
  ...
  class LaserDetection : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "human_tracking/LaserDetection"; };
    const char * getMD5(){ return "38c944e69076859c0391ebddc998687a"; };
